...
import gymImage from "../assets/images/backgrounds/bg_coaches.jpg";
  ...
  return (
    <>
      <div className="main-banner" id="top">
        ...
        <div className="video-overlay header-text"></div>
      </div>
      ...
      <div className="coaches-board">
        <div className="coach-card">
          hhh
          {/* <div className="coach-pic"></div> */}
        </div>
        <div className="coach-card">hhh</div>
        <div className="coach-card">hhh</div>
        <div className="coach-card">hhh</div>
        <div className="coach-card">hhh</div>
        <div className="coach-card">hhh</div>
